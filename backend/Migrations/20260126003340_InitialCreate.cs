        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyWorkHours = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExitTime = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    IsAbsent = table.Column<bool>(type: "INTEGER", nullable: false),
                    OvertimeHours = table.Column<decimal>(type: "decimal(5, 2)", nullable: false),
                    DoubleTimeHours = table.Column<decimal>(type: "decimal(5, 2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CycleType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    IsProcessed = table.Column<bool>(type: "INTEGER", nullable: false),
                    PayrollDetails = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
